...
public class NinePatchTexture {
    ...
    public static void draw(Identifier texture, MatrixStack matrices, int x, int y, int width, int height) {
        ifPresent(texture, ninePatchTexture -> ninePatchTexture.draw(matrices, x, y, width, height));
    }

    public static void draw(Identifier texture, MatrixStack matrices, PositionedRectangle rectangle) {
        ifPresent(texture, ninePatchTexture -> ninePatchTexture.draw(matrices, rectangle));
    }
