...
public class Hud {
    ...
    public static final GuiLayerManager.NamedLayer HUD_LAYER = new GuiLayerManager.NamedLayer(Identifier.fromNamespaceAndPath("owo", "owo_ui_hud"), (context, tickCounter) -> {
