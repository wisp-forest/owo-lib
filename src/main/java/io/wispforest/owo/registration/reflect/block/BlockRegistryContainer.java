...
public abstract class BlockRegistryContainer extends AutoRegistryContainer<Block> {
    ...
    public static <T extends Block> BlockRegistryEntry<T> block(Function<AbstractBlock.Settings, T> factory) {
        return block(factory, AbstractBlock.Settings.create());
    }

    public static <T extends Block> BlockRegistryEntry<T> block(Function<AbstractBlock.Settings, T> factory, AbstractBlock.Settings settings) {
        return new BlockRegistryEntry<>(factory, settings);
    }
