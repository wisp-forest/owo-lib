...
public class ComponentMapImplMixin {
    ...
    @WrapOperation(method = "equals", at = {
        @At(value = "INVOKE", target = "Lnet/minecraft/component/ComponentMap;equals(Ljava/lang/Object;)Z"),         // YARN
        @At(value = "INVOKE", target = "Lnet/minecraft/core/component/DataComponentMap;equals(Ljava/lang/Object;)Z") // MOJMAP
    })
