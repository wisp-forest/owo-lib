...
public abstract class NamespaceResourceManagerMixin {
    ...
    private boolean json5$findResources(
        ...
        String namespace,
        String startingPath,
        ResourcePack.ResultConsumer resultConsumer,
    ...
    @WrapWithCondition(
        ...
        at = @At(
            value = "INVOKE",
            target = "Lnet/minecraft/resource/NamespaceResourceManager;findAndAdd(Lnet/minecraft/resource/NamespaceResourceManager$FilterablePack;Ljava/lang/String;Ljava/util/function/Predicate;Ljava/util/Map;)V"
        )
    )
    private boolean json5$findAllResources(
        NamespaceResourceManager instance,
