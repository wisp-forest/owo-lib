...
public record KeyedEndecEncodeError(KeyedEndec<?> key, Object obj, Exception exception, boolean encodedDefaultValue, boolean sendEntireException) implements ErrorReporter.Error {
