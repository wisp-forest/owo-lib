...
public interface ValueMapper {
    double toNormalized(double value, double min, double max);

    double fromNormalized(double normalizedValue, double min, double max);

    ValueMapper LINEAR = new ValueMapper() {
        @Override
        public double toNormalized(double value, double min, double max) {
            return (value - min) / (max - min);
        }

        @Override
        public double fromNormalized(double normalizedValue, double min, double max) {
