...
import io.wispforest.owo.config.ui.component.struct.RecordStructOptionContainer;
import io.wispforest.owo.config.ui.component.struct.StructOptionContainer;
    ...
    protected <P extends OptionValueProvider & Component> P createProviderComponent(T listEntry) {
        ...
        if (structLike) {
            ...
            if (NumberReflection.isNumberType(listType())) {
                ...
                var data = ConfigReflectionUtils.getRangeConstraintData(numberType, this.backingOption);
