...
public final class FieldOption<T> extends OptionBase<T> implements ReflectiveOption<T> {
    ...
    ///
    /// @param configId     The [Identifier] of the config this option is contained in
    ...
    public FieldOption(Identifier configId,
        ...
        super(configId, key, defaultValue, backingField.type(), backingField.genericType(), constraint);
        ...
        this.endec = (Endec<T>) builder.get(this.getGenericType());
    }
    ...
    /// @return `null` if this option was successfully detached,
    ...
    ///
    /// @return `true` if this option is currently detached
    ///
