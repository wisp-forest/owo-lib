...
public class OwoReiPlugin implements REIClientPlugin {
    ...
    static {
        ScreenEvents.AFTER_INIT.register((client, screen, scaledWidth, scaledHeight) -> {
            ...
            ScreenEvents.beforeRender(screen).register(($, matrices, mouseX, mouseY, tickDelta) -> {
                ...
                surface.callback = () -> {
                    ...
                    renderOverlay($, () -> renderSink.render(matrices, mouseX, mouseY, tickDelta));
                };
            });
    ...
    private static class CallbackSurface implements Surface {
        ...
        public void draw(MatrixStack matrices, ParentComponent component) {
            this.inner.draw(matrices, component);
            this.callback.run();
        }
    }
}
